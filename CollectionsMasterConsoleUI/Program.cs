...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
          ...
          {
                Console.WriteLine("yes, we have that number in the list");
          }
          else
          {
                Console.WriteLine("nope, dont have that number in my list");
          }
        ...
        {
            //STAY OUT DO NOT MODIFY!!*but what if i wanna-from kyle*
